...
fulltext_results = ["doc1", "doc2", "doc3"]
# 矢量检索排名 向量检索排名 稠密检索排名 向量就384维度
vector_results = ["doc3", "doc2", "doc4"]
rankings = [fulltext_results, vector_results]
weights = [0.7, 0.3]

fused_results = reciprocal_rank_fusion(rankings, weights, k=1000)
print("关键词检索结果", fulltext_results)
